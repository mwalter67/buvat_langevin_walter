...
Notre jeu de données contients 284807 obsérvations, ainsi que les 31 variables suivante:  

-Umont: Coût de la transaction en dollar  
-v1 : v28: Composant optenue a l'aide d'une acp affin d'anonymiser les personnes.    
...
On cherche à construire un modèle qui prédit la fraude ou non d'un client en foction des autres variables apr la méthode du SVM.
