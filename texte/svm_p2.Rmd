...
Dans la pratique les données sont rarement linéairement séparables. Dans ce cas il n’existe pas d’hyperplan capable de séparer correctement les données. On distingue alors deux cas :  
...
À l'inverse, quand C est petit on pénalise moins les erreurs de classification et l'importance est donnée à la maximisation de la marge. On a ici un risque de __sous-apprentissage__.


### Kernel Trick ou astuce du noyau
Quand les données ne sont pas linéairement séparables, il est possible qu'elles le soient dans un espace de plus grandes dimensions. 
